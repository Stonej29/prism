            ...
            [
                {
                    ...
                    **({"similarity": related_similarity} if related_similarity is not None else {}),
                }
                for rid in related
            ]
        ),
...
class WebApiTest(unittest.TestCase):
    ...
    def test_graph_dedup_and_dangling(self) -> None:
        ...
        self.db.insert_note(make_note("aaa111", related=["bbb222", "zzz999"], related_origin="auto", related_similarity=0.84))
        ...
        self.assertEqual(graph["edges"][0]["similarity"], 0.84)
