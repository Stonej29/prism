...
from prism.web.routes import activity, files, graph, ideas, maintenance, notes, proposals, search, stats, tags, tree
...
def create_app() -> FastAPI:
    ...
    for module in (notes, graph, tags, stats, search, ideas, proposals, maintenance, tree, files, activity):
